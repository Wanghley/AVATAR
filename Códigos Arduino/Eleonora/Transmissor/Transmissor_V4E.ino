...
void setup()
{
  ...
  sent_data.ch4 = 0; //eixo x
  sent_data.ch5 = 0; //eixo y
//  sent_data.ch6 = 0;
//  sent_data.ch7 = 0;
}
...
//{
  ...
  giroEixoX = 110; //obter dados do eixo x do giroscópio
  giroEixoY = -98; //obter dados do eixo y do giroscópio
  ...
  if (joyposVert <= 513)
  {
    ...
    motorcontrol[0] = map(joyposVert, 513, 0, 100, 255);
    motorcontrol[1] = map(joyposVert, 513, 0, 100, 255);
  ...
  else if (joyposVert > 514)
  {
    ...
    //Determine Motor Speeds
    motorcontrol[0] = map(joyposVert, 514, 1023, 100, 255);
    motorcontrol[1] = map(joyposVert, 514, 1023, 100, 255); 
  ...
  if (joyposHorz < 500)
  {
    ...
    joyposHorz = map(joyposHorz, 500, 0, 100, 255);
  ...
  else if (joyposHorz > 510)
  {
    // Move Right
    // Map the number to a value of 255 maximum
    joyposHorz = map(joyposHorz, 510, 1023, 100, 255);
